...
func init() {
	...
	groupDescAllowBalanceFallback := groupFields[47].Descriptor()
	...
	groupDescProtectedModels := groupFields[48].Descriptor()
	...
	groupDescProtectedModelQuotas := groupFields[49].Descriptor()
