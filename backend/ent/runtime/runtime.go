...
func init() {
	...
	groupDescAllowBalanceFallback := groupFields[39].Descriptor()
	...
	groupDescProtectedModels := groupFields[40].Descriptor()
	...
	groupDescProtectedModelQuotas := groupFields[41].Descriptor()
