...
func init() {
	...
	groupDescAllowBalanceFallback := groupFields[52].Descriptor()
	...
	groupDescProtectedModels := groupFields[53].Descriptor()
	...
	groupDescProtectedModelQuotas := groupFields[54].Descriptor()
