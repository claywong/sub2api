...
func init() {
	...
	groupDescAllowBalanceFallback := groupFields[36].Descriptor()
	...
	groupDescProtectedModels := groupFields[37].Descriptor()
	...
	groupDescProtectedModelQuotas := groupFields[38].Descriptor()
