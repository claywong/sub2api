...
func (h *OpenAIGatewayHandler) AlphaSearch(c *gin.Context) {
	...
	if err := h.billingCacheService.CheckBillingEligibility(c.Request.Context(), apiKey.User, apiKey, apiKey.Group, subscription, service.QuotaPlatform(c.Request.Context(), apiKey), requestedModel); err != nil {
