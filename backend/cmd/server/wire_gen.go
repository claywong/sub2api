...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	adminModelQuotaService := service.NewAdminModelQuotaService(userGroupModelUsageRepository, groupRepository, billingCacheService)
	modelQuotaHandler := admin.NewModelQuotaHandler(adminModelQuotaService)
